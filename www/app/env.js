...
(function (window) {
  ...
  var environment = ""; //can be dev, test or prod.

  //environment specific constants
  if(environment === "prod") {
    window.__env.uiServerUrl = 'http://ec2-52-90-74-144.compute-1.amazonaws.com:8083';
    window.__env.userServerUrl = 'http://ec2-52-90-74-144.compute-1.amazonaws.com:8080';
    window.__env.refDataUrl = 'http://ec2-52-90-74-144.compute-1.amazonaws.com:8081/core';
    window.__env.nodeJsUrl = 'http://ec2-52-90-74-144.compute-1.amazonaws.com:8001/api';
    window.__env.notificationServerUrl = 'http://ec2-52-90-74-144.compute-1.amazonaws.com:8082/notification';
    window.__env.dataServerUrl = 'http://ec2-52-90-74-144.compute-1.amazonaws.com:8084';

...
(function() {
  ...
  function routerHelperProvider($locationProvider, $stateProvider, $urlRouterProvider) {
    ...
    RouterHelper.$inject = ['$location', '$rootScope', '$state', 'logger', 'authorization', 'principal', '$ionicLoading'];
    /* @ngInject */
    function RouterHelper($location, $rootScope, $state, logger, authorization, principal, $ionicLoading) {
